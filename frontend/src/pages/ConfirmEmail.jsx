    ...
    <>
        ...
        <section className={classes.page}>
            ...
            <div className={classes.layout}>
                ...
                <p className={classes.subHeading}>We have sent you an email with a confirmation link to {email && email}. To begin using GymBro, please confirm your email address.</p>
